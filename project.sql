...
(   open_major varchar(20) not null,
    enrollment int,
    uni_id char(10) not null,
...
(   que_id char(20) not null,
    que_analysis varchar(100) not null,
    difficulty_level int not null,
    que_content varchar(200) not null,
